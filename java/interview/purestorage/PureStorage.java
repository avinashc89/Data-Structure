package com.tool.java.interview.purestorage;
...
public class PureStorage {
	...
	//given a string, find the count of palindrome substring present in that string




	public static void main(String[] args) {
		System.out.println(new PureStorage().longestPalindrome("hellolle"));
	}
